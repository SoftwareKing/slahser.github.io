...
![2016-06-03_Screen Shot 2016-06-03 at 03.44.44.png](https://o4dyfn0ef.qnssl.com/2016-06-03_Screen Shot 2016-06-03 at 03.44.44.png?imageView2/2/h/300) 
...
motan manager中则是web控制台,操作service完成一些黑话版的功能,此处不做介绍了. 

鉴于手头没有集群,我的13 late的机器配置也跟不上,姑且还没有实战去使用一下.或许以后会进行一次配置,顺便熟悉一下consul的使用. 
